...
ARLEN_WINDOWS_FOCUSED_TEST_RUNNER ?= $(ARLEN_XCTEST)
TEST ?=
SKIP_TEST ?=
...
>mkdir -p $(GNUSTEP_TEST_HOME)/GNUstep/Defaults/.lck
>source $(GNUSTEP_SH) && export HOME="$(GNUSTEP_TEST_HOME)" GNUSTEP_USER_DIR="$(GNUSTEP_TEST_HOME)/GNUstep" GNUSTEP_USER_ROOT="$(GNUSTEP_TEST_HOME)/GNUstep" GNUSTEP_USER_DEFAULTS_DIR="$(GNUSTEP_TEST_HOME)/GNUstep/Defaults" && $(xctest_runtime_env) "$(ARLEN_WINDOWS_FOCUSED_TEST_RUNNER)" $(PHASE24_WINDOWS_DB_SMOKE_TEST_BUNDLE)
