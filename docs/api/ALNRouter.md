...
| `addRouteMethod:path:name:formats:controllerClass:guardAction:action:policies:` | `- (ALNRoute *)addRouteMethod:(NSString *)method path:(NSString *)path name:(nullable NSString *)name formats:(nullable NSArray *)formats controllerClass:(Class)controllerClass guardAction:(nullable NSString *)guardAction action:(NSString *)action policies:(nullable NSArray *)policies;` | Add this item to the current runtime collection. | Call during bootstrap/setup before this behavior is exercised. |
