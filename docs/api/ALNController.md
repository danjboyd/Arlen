...
| `params` | `- (NSDictionary *)params;` | Return merged request parameters (query string, `application/x-www-form-urlencoded` body fields, route params, then validated values). | Read this value when you need current runtime/request state. |
