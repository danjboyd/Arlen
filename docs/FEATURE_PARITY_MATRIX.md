...
| Server-driven live fragments, forms, keyed collections, and navigation baseline | Phoenix LiveView, Hotwire/Turbo, Symfony UX LiveComponent, Livewire | In Scope | Phase 25 (complete) | Fragment-first HTML-over-the-wire baseline ships with `ALNLive`, `/arlen/live.js`, live request metadata, keyed collection helpers, live regions, upload-progress-aware forms, and websocket-backed push updates. |
