...
- [Phase 20 Roadmap](PHASE20_ROADMAP.md): delivered `20A-20K` data-layer depth work plus planned `20L-20N` follow-ons for MSSQL transport tightening, result row-order semantics, and optional broader reflection.
