...
- [Phase 37 Roadmap](PHASE37_ROADMAP.md): completed public-release test confidence phase; `37A-37L` delivered the public-surface contract, EOC golden-render catalog, deterministic parser/protocol corpus, acceptance harness, EOC/MVC/module/data/live/deploy acceptance sites, `phase37-confidence`, and closeout docs.
