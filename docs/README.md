...
- [Phase 32 Roadmap](PHASE32_ROADMAP.md): target-aware deployment architecture phase; `32A-32I` now cover the platform-profile support matrix, deploy-target config contract, remote rebuild gating, expanded release manifests, and deeper deploy status/rollback metadata.
