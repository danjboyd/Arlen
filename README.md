...
- Phase 27: planned (`27A-27L` scoped on 2026-04-01 for the search best-in-class push: safe result shaping, a first-party PostgreSQL FTS baseline, first-party Meilisearch and OpenSearch/Elasticsearch engines, richer query semantics, stronger auth/tenant visibility rules, and search-specific confidence artifacts. See `docs/PHASE27_ROADMAP.md`).
