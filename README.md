...
- Phase 24: in progress on branch `windows/clang64` (`24A-24M` delivered on 2026-03-31 for the MSYS2 `CLANG64` preview contract; `24N-24S` now track the remaining work required to bring Windows to Linux parity. See `docs/PHASE24_ROADMAP.md`).
