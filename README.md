...
- Phase 27: complete (`27A-27L` delivered on 2026-04-01). The search module now ships safe public result shaping, typed/capability-normalized metadata, PostgreSQL FTS/trigram, first-party Meilisearch and OpenSearch adapters, replay/tenant/soft-delete-aware lifecycle state, `arlen generate search`, focused adapter/lifecycle/admin suites, and `phase27-confidence`. See `docs/PHASE27_ROADMAP.md`.
