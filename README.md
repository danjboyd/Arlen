...
- Phase 20: extended (`20A-20F` delivered on 2026-03-26; `20G-20K` now planned for relation-kind-aware reflection, deeper type parity, broader inspector coverage, lighter Core-style execution ergonomics, and clearer PostgreSQL/MSSQL support tiers. See `docs/PHASE20_ROADMAP.md`).
