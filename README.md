...
- Phase 24: complete on branch `windows/clang64` (`24A-24S` delivered on 2026-04-06 for the checked-in MSYS2 `CLANG64` Windows parity and release contract. See `docs/PHASE24_ROADMAP.md`).
