...
- Phase 25: baseline complete (`25A-25G` delivered on 2026-04-01 for fragment-first live UI: `ALNLive`, `/arlen/live.js`, live request metadata, keyed collection helpers, lazy/poll/deferred regions, upload-progress-aware live forms, `phase25-live-tests`, and `phase25-confidence`). Follow-on testing hardening is now scoped as `25H-25L` in `docs/PHASE25_ROADMAP.md`. Full diff-engine/live-component depth remains future work.
