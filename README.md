...
- Phase 20: complete (`20A-20K` delivered on 2026-03-26: typed codecs/live rows, recursive nested dialect compilation, result/savepoint ergonomics, inspector/codegen depth, routing/pool hardening, relation-kind-safe reflection, richer type parity, backend support tiers, and MSSQL operational baseline hardening. See `docs/PHASE20_ROADMAP.md`).
