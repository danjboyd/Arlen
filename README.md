...
- Phase 27: in progress (`27A-27D` delivered on 2026-04-01 for safe result shaping, metadata/capability normalization, the first-party PostgreSQL FTS/trigram engine, and richer search query sections; `27E-27L` remain for external engines, larger-index hardening, auth/tenant depth, and confidence closeout. See `docs/PHASE27_ROADMAP.md`).
