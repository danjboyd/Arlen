...
- Phase 20: extended (`20A-20I` delivered on 2026-03-26: typed codecs/live rows, recursive nested dialect compilation, result helpers, inspector/codegen depth, routing/pool hardening, relation-kind-safe reflection, richer type parity, and inspector v2 metadata; `20J-20K` remain planned for result/savepoint ergonomics and backend support-tier hardening. See `docs/PHASE20_ROADMAP.md`).
