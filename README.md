...
- Phase 24: complete on branch `windows/clang64` (`24A-24U` delivered on 2026-04-07 for the checked-in MSYS2 `CLANG64` Windows parity, release contract, PowerShell-first launcher wrappers, and Windows-native `arlen service` install/uninstall support; Linux `systemd` wiring remains a later follow-up behind the same CLI surface. See `docs/PHASE24_ROADMAP.md`).
