...
@interface Phase7FTests : XCTestCase
@end

@implementation Phase7FTests
...
- (void)testFrontendStarterContractFixtureSchemaAndTestCoverage {
  NSDictionary *fixture =
      [self loadJSONFileAtRelativePath:@"tests/fixtures/phase7f/frontend_starter_contracts.json"];
  XCTAssertEqualObjects(@"phase7f-frontend-starter-contracts-v1", fixture[@"version"]);
