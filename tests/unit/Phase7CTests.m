...
@interface Phase7CTests : XCTestCase
@end

@implementation Phase7CTests
...
- (void)testObservabilityAndOperabilityContractFixtureSchemaAndTestCoverage {
  NSDictionary *fixture =
      [self loadJSONFileAtRelativePath:@"tests/fixtures/phase7c/observability_operability_contracts.json"];
  XCTAssertEqualObjects(@"phase7c-observability-contracts-v1", fixture[@"version"]);
