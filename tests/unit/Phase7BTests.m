...
@interface Phase7BTests : XCTestCase
@end

@implementation Phase7BTests
...
- (void)testSecurityPolicyContractFixtureSchemaAndTestCoverage {
  NSDictionary *fixture =
      [self loadJSONFileAtRelativePath:@"tests/fixtures/phase7b/security_policy_contracts.json"];
  XCTAssertEqualObjects(@"phase7b-security-contracts-v1", fixture[@"version"]);
