...
@interface Phase7ATests : XCTestCase
@end

@implementation Phase7ATests
...
- (void)testRuntimeHardeningContractFixtureSchemaAndTestCoverage {
  NSDictionary *fixture =
      [self loadJSONFileAtRelativePath:@"tests/fixtures/phase7a/runtime_hardening_contracts.json"];
  XCTAssertEqualObjects(@"phase7a-runtime-contracts-v1", fixture[@"version"]);
