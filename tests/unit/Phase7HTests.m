...
@interface Phase7HTests : XCTestCase
@end

@implementation Phase7HTests
...
- (void)testDistributedRuntimeDepthContractFixtureSchemaAndTestCoverage {
  NSDictionary *fixture =
      [self loadJSONFileAtRelativePath:@"tests/fixtures/phase7h/distributed_runtime_contracts.json"];
  XCTAssertEqualObjects(@"phase7h-distributed-runtime-contracts-v1", fixture[@"version"]);
