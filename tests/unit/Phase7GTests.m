...
@interface Phase7GTests : XCTestCase
@end

@implementation Phase7GTests
...
- (void)testCodingAgentDXContractFixtureSchemaAndTestCoverage {
  NSDictionary *fixture =
      [self loadJSONFileAtRelativePath:@"tests/fixtures/phase7g/coding_agent_dx_contracts.json"];
  XCTAssertEqualObjects(@"phase7g-coding-agent-dx-contracts-v1", fixture[@"version"]);
