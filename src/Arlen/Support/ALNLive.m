...
+ (NSString *)runtimeJavaScript {
  ...
  dispatch_once(&onceToken, ^{
    script = [@[
      ...
      @"    start: start,",
      @"    __testing: {",
      @"      collectLiveRequestMetadata: collectLiveRequestMetadata,",
      @"      handleLiveTextResponse: handleLiveTextResponse,",
      @"      submitLiveForm: submitLiveForm,",
      @"      followLiveLink: followLiveLink,",
      @"      fetchLiveRegion: fetchLiveRegion,",
      @"      activateRegion: activateRegion,",
      @"      scanLiveRegions: scanLiveRegions,",
      @"      scanStreams: scanStreams,",
      @"      parseDuration: parseDuration,",
      @"      retryAfterMillis: retryAfterMillis,",
      @"      regionStateFor: regionStateFor",
      @"    }",
      @"  };",
      @"})();"
